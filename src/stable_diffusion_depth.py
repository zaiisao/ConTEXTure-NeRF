...
class StableDiffusion(nn.Module):
    ...
    #                  num_inference_steps=100, update_mask=None, latent_mode=False, check_mask=None,
    ...
    #                 #is_inpaint_range = self.use_inpaint and (10 < i < 20)
    #                 is_inpaint_range = self.use_inpaint
                    
    #                 mask_constraints_iters = True  # i < 20
    #                 is_inpaint_iter = is_inpaint_range   and i %2 == 1
                    
    #                 #MJ: While not performing inpainting, perform blending before the execution of the denoising step
    #                 # either by the depth pipeline or the inpaint pipeline; during in-painting, the blending operation is performed automatically

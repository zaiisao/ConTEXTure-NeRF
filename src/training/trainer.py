...
class TEXTure:
    ...
    def paint_zero123plus(self):
        ...
        #MJ: At this point, self.texture_img has been learned from the front view image; So when the mesh is rendered 
        # hereafter  this learned texture map will be used.
